   ...
   public enum SynchronizedQueueResult {
    ...
    public static SynchronizedQueueResult testQueue(QueueAdapter<Integer> queue) {
        try {
            ...
            Thread consumer = new Thread(SynchronizedQueue.consumerRunnable);
            Thread producer = new Thread(SynchronizedQueue.producerRunnable);
            ...
            // exit.
            consumer.join(TIMEOUT_SECONDS);
            producer.join(TIMEOUT_SECONDS);
